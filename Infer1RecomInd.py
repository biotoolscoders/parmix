...
import math
import random
from emissions1Ind import *
from TransitionsInd import *


def InferRecomInd(Nc, Ng, Recomb, PositionFile, ChildrenFile, Ge):
    ...
    emission = emI1(EC,Ge,len(states),len(alphabet), Nc)
